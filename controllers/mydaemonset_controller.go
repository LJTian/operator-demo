...
import (
	...
	appsv1 "ljtian.com/mydaemonset/api/v1"
)
...
//+kubebuilder:rbac:groups=apps.ljtian.com,resources=mydaemonsets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=apps.ljtian.com,resources=mydaemonsets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=apps.ljtian.com,resources=mydaemonsets/finalizers,verbs=update
		...
		for _, n := range nl.Items {
			p := v1.Pod{
				...
				ObjectMeta: meta.ObjectMeta{
					GenerateName: fmt.Sprintf("%s-", "myds"),
